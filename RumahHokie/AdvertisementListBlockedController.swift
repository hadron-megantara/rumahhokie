//
//  AdvertisementListBlockedController.swift
//  RumahHokie
//
...
class AdvertisementListBlockedController: UIViewController, UITextFieldDelegate {
    ...
    func loadList(){
        ...
        let urlVar = "http://api.rumahhokie.com/agt_user/\(self.agentId)/cnt_listing?cnt_status_id=5&view=short&offset=0&limit=\(limitFilter)&order_by=\(orderBy)&order_type=desc"
...
extension AdvertisementListBlockedController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if !isResultEmpty{
            let cell = tableView.dequeueReusableCell(withIdentifier: "cellListPropertyAgentPublishBlocked", for: indexPath) as UITableViewCell
            ...
            let cell2 = tableView.dequeueReusableCell(withIdentifier: "cellListPropertyAgentPublishBlockedEmpty", for: indexPath) as! EmptyListProperty
            return cell2
        }
    }
}

extension AdvertisementListBlockedController : UITableViewDelegate {
